...
plot(x = smElecUsed$DateTime2, y = smElecUsed$Global_active_power, type = "l", ylab = "Global Active Power", xlab = "")

plot(x = smElecUsed$DateTime2, y = smElecUsed$Voltage, type = "l", ylab = "Voltage", xlab = "datetime")
...
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), cex = 0.75  , col = c("black", "red", "blue"), text.col = "black", lty = c(1, 1, 1), bty = "n")

plot(x = smElecUsed$DateTime2, y = smElecUsed$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
